...
const saturateValues = ["saturate-[0.3]", "saturate-[0.5]", "saturate-[0.7]", "saturate-[0.8]", "saturate-[0.9]", "saturate-[1]", "saturate-[1.1]", "saturate-[1.1]", "saturate-[1.1]", "saturate-[1.2]", "saturate-[1.2]"];
...
let variables;
// user has choose 33xp per completion that means 3x or 3 days in a weeek
// below condition is based on above information
function switchCaseFunctionFor3x(count, setCount, counts, setCounts, levelIndex, setLevelIndex, total) {
...
export default switchCaseFunctionFor3x;