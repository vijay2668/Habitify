...
// user has choose 14xp per completion that means 7x or 7 days in a week
// below condition is based on above information
function switchCaseFunctionFor7x(count, setCount, counts, setCounts, levelIndex, setLevelIndex, total) {
...
export default switchCaseFunctionFor7x;