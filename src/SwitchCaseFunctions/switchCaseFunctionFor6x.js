...
// user has choose 17xp per completion that means 6x or 6 days in a week
// below condition is based on above information
function switchCaseFunctionFor6x(count, setCount, counts, setCounts, levelIndex, setLevelIndex, total) {
...
export default switchCaseFunctionFor6x;