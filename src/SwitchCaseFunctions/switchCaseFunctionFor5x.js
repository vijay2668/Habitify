...
// user has choose 20xp per completion that means 5x or 5 days in a week
// below condition is based on above information
function switchCaseFunctionFor5x(count, setCount, counts, setCounts, levelIndex, setLevelIndex, total) {
...
export default switchCaseFunctionFor5x;